...
function EditUserInfo() {
  ...
  return (
    <div className="adminpage addportfolio">
      ...
      <div className="df">
        ...
        <div className="input-group input-group-icon">
                    ...
                    <div className="df">
                    <input type="text" placeholder="Image URL" value={projectImage} onChange={handleProjectImageChange} />
    ...
    <div className="df">
        <input type="text" placeholder="Image URL" value={testimonialImage} onChange={handleTestimonialImageChange} />
